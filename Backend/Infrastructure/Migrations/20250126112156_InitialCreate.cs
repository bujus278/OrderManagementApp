    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "0123456", "bond@wp.pl", "James", false, "BOnd" },
                    { 2, "1234567", "monty@wp.pl", "Monty", false, "Pyton" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 10m, "new order", false, true, new DateTime(2024, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "New notes", 0, 500m },
                    { 2, 2, 250m, "secund order", false, false, new DateTime(2024, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Some notes", 1, 5000m }
                });
